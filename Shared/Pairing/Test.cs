...
namespace IXAge_Pairing
{
    ...
    public class BuildTree
    {
        ...
        static List<List<(int, int)>> Data = new List<List<(int, int)>>();
        static public Dictionary<ulong, int> DataString = new Dictionary<ulong, int>();
        public static void RunTestPhase3(PairingScenario elems, (ulong, ulong) fight1, (ulong, ulong) fight2, (ulong, ulong) fight3, ulong j, ulong prevJ, ulong lastJ, ref int cpt)
        {
        ...
        public static void RunTestPhase2(PairingScenario elems, (ulong, ulong) fight1, (ulong, ulong) fight2, ref int cpt)
        {
            var cFight = fight1.Item1 * 100000000000 + fight1.Item2 * 10000000000 + fight2.Item1 * 1000000000 + fight2.Item2 * 100000000;
            for (ulong i = 0; i < 6; i++)
            {
        ...
        public static void RunTest(PairingScenario elems)
        {
            int cpt = 0;
            for (ulong i = 0; i < 6; i++)
            {
